      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div id="field-socialHistory" className={`${guidedFlowStep === 3 && isListening ? 'ring-8 ring-emerald-400/70 rounded-xl p-3 -m-3 bg-emerald-500/15 animate-pulse shadow-2xl shadow-emerald-500/50' : ''} transition-all duration-300`}>
                  <div className="mb-2">
                ...
                {/* Allergies - Step 5 */}
                <div id="field-allergies" className={`${guidedFlowStep === 5 && isListening ? 'ring-8 ring-emerald-400/70 rounded-xl p-3 -m-3 bg-emerald-500/15 animate-pulse shadow-2xl shadow-emerald-500/50' : ''} transition-all duration-300`}>
                  <div className="flex items-center justify-between mb-2">
        ...
        <div className="relative overflow-hidden bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-xl rounded-2xl shadow-2xl p-8 mb-6 border border-slate-700/50">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Lab Tests - Step 8 */}
              <div id="field-labTests" className={`${guidedFlowStep === 8 && isListening ? 'ring-8 ring-emerald-400/70 rounded-xl p-3 -m-3 bg-emerald-500/15 animate-pulse shadow-2xl shadow-emerald-500/50' : ''} transition-all duration-300`}>
                <div className="flex items-center justify-between mb-2">
              ...
              {/* Advice - Step 9 */}
              <div id="field-advice" className={`${guidedFlowStep === 9 && isListening ? 'ring-8 ring-emerald-400/70 rounded-xl p-3 -m-3 bg-emerald-500/15 animate-pulse shadow-2xl shadow-emerald-500/50' : ''} transition-all duration-300`}>
                <div className="flex items-center justify-between mb-2">
